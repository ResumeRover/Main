  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-900'} transition-colors duration-300`}>
      ...
      <div className="container mx-auto px-6 pt-24 pb-16">
        ...
        {/* Error Message */}
        {error && (
          <div className={`mb-6 p-4 rounded-xl ${isDarkMode ? 'bg-red-900/30' : 'bg-red-50'} border ${isDarkMode ? 'border-red-800' : 'border-red-200'} ${isDarkMode ? 'text-red-300' : 'text-red-600'}`}>
