...
function App() {
  const [activeGroup, setActiveGroup] = useState('group11');
  const [activeTab, setActiveTab] = useState('cv-details');
  ...
  const groups = [
    ...
    { id: 'group9', name: 'Group 9', icon: 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    { id: 'group10', name: 'Group 10', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    { id: 'group11', name: 'CV Verification', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    { id: 'group12', name: 'Group 12', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' }
  ];
  ...
  const tabs = {
    ...
    group10: [
      ...
      { id: 'fairness-metrics', name: 'Fairness Metrics' }
    ],
    group11: [
...
<div className="flex-1 flex flex-col overflow-hidden">
  {/* Navbar */}
  <div className="h-16 bg-gray-900/70 backdrop-blur-xl rounded-bl-2xl shadow-lg border-b border-gray-800/40 flex items-center justify-between px-6">
    ...
    <div className="flex items-center space-x-4">
      <div className="relative">
        <input 
          ...
          className="bg-gray-800/50 text-sm border border-gray-700/50 rounded-full px-4 py-1.5 w-52 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent"
        />
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <button className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 shadow-md hover:shadow-lg">
        Take Notes
      </button>
      <div className="flex items-center space-x-4">
        <div className="relative">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-300 hover:text-white cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="h-8 w-8 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 flex items-center justify-center text-white text-sm font-bold cursor-pointer">
          CS
        </div>
      </div>
    </div>
